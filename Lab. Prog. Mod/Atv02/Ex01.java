...
public class Ex01 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("[ 1 ] Adicionar dias a data atual.\n[ 2 ] Verificar data mais futura.\n[ 3 ] Imprimir data atual.");
            esc = ler.nextInt();
            switch (esc) {
                case 1:
                    System.out.println("Quantos dias voce pretende adicionar?");
                    int n = ler.nextInt();
                    d.adicionaDias(n);
                    break;
                case 2:
                    ...
                    if (d1.dia == d2.dia  && d1.mes == d2.mes && d1.ano == d2.ano) {
                        System.out.println("As duas datas digitadas são iguais!");
                    } else {
                        Data resp = d.verificaFutura(d1, d2);
                        System.out.print("Data mais futura: ");
                        resp.imprimeData();
                    }
                    break;
                case 3:
