...
public class Ex08 {
    public static void main(String[] args) {
        ...
        if (!A.pesquisar(elemento)) {
            ...
            System.out.println("Primeira ocorrencia do elemento "+elemento+" = posicao [" + A.primeiraOcorrenciaDe(elemento)+"]");
        }
        ...
        if (!B.pesquisar(elemento)) {
            ...
            System.out.println("Primeira ocorrencia do elemento "+elemento+" = posicao [" + B.primeiraOcorrenciaDe(elemento)+"]");
        }
        ...
        if (!AmaisB.pesquisar(elemento)) {
            ...
            System.out.println("Primeira ocorrencia do elemento "+elemento+" = posicao [" + AmaisB.primeiraOcorrenciaDe(elemento)+"]");
        }
